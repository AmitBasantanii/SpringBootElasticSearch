...
public class ProductRepository {
    ...
    public String deleteDocById(String productId) throws IOException {
        ...
        return new StringBuffer(response.result().name().equalsIgnoreCase("NOT_FOUND") ? "Document not found with id " + productId: " Document has been deleted").toString();
    ...
    // saving multiple documents at the same time
